...
export const destruction: Tree = {
  ...
  talents: [
    ...
    },
    {
      ...
      ranks: [
        "Reduces the casting time of your Imp's Firebolt spell by 0.006 sec and decreases its mana cost by 0%. When your Imp's Firebolt critically hits, you have a 107% chance to gain Impish Fire, increasing the initial damage of your next single target Fire spell by 10%.",
        "Reduces the casting time of your Imp's Firebolt spell by 0.006 sec and decreases its mana cost by 0%. When your Imp's Firebolt critically hits, you have a 107% chance to gain Impish Fire, increasing the initial damage of your next single target Fire spell by 10%.",
      ],
    ...
    },
    {
      ...
      ranks: [
        "Reduces the cooldown of your Succubus' Lash of Pain spell by 0.006 sec.",
        "Reduces the cooldown of your Succubus' Lash of Pain spell by 0.006 sec.",
      ],
