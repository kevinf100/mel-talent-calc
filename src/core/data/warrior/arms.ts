...
import backgroundImage from '../../../assets/images/warrior/background-warrior-arms.webp?format=avif&quality=80&imagetools'
...
export const arms: Tree = {
  ...
  talents: [
    ...
    },
    {
      ...
      name: 'Deep Wounds',
      ranks: [
        "Your critical strikes cause the opponent to bleed, dealing 20% of your melee weapon's average damage over 0.",
        "Your critical strikes cause the opponent to bleed, dealing 40% of your melee weapon's average damage over 0.",
        "Your critical strikes cause the opponent to bleed, dealing 60% of your melee weapon's average damage over 0.",
      ],
