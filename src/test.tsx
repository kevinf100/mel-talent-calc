...
export const Layout = (layoutProps: TLayoutProps) => {
  const { children } = layoutProps;

  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-100">
      <header className="w-full bg-white p-4 shadow">Header</header>
      ...
      <footer className="w-full bg-white p-4 shadow">Footer</footer>
    </div>
  );
};
